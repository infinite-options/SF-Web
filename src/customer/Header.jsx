  ...
  return (
    <div>
      ...
      <div>
        <div
          className={
            fruitClick ? 'link4Button sort1' : 'link4Button sort1 colorClick'
          }
          onClick={fruitClicking}
        >
          <img
            className="iconBlock positioningSsort"
            src={
              fruitClick
                ? './footer_icon/Asset 7.png'
                : './footer_icon/orangeFruit.png'
            }
            alt="fruit-img"
          ></img>
          <span>fruits</span>
        ...
        <div
          className={
            vegeClick ? 'link4Button sort2' : 'link4Button sort2 colorClick'
          }
        ...
        >
          <img
            ...
            src={
              vegeClick
                ? './footer_icon/Asset 4.png'
                : './footer_icon/orangeVegetable.png'
            }
            alt="vegetable-img"
          ></img>
        ...
        <div
          className={
            dessertClick ? 'link4Button sort3' : 'link4Button sort3 colorClick'
          }
        ...
        >
          <img
            ...
            src={
              dessertClick
                ? './footer_icon/Asset 6.png'
                : './footer_icon/orangeDessert.png'
            }
            alt="desert-img"
          ></img>
          <span>Desserts</span>
        ...
        <div
          className={
            othersClick ? 'link4Button sort4' : 'link4Button sort4 colorClick'
          }
        ...
        >
          <img
            ...
            src={
              othersClick
                ? './footer_icon/Asset 5.png'
                : './footer_icon/orangeOthers.png'
            }
            alt="bread-img"
          ></img>
          <span>Others</span>
