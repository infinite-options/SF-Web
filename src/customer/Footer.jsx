      ...
      <div>
        <div className="linkFooter homeIcon" onClick={homeClicking}>
          <img
            className="iconBlock"
            src={
              cartContext.currentFootClick !== 'days'
                ? './footer_icon/Asset 1.png'
                : './footer_icon/daysFooter.png'
            }
            alt="card-img"
          ></img>
          <span>Days</span>
        ...
        <div className="linkFooter orderIcon" onClick={orderClicking}>
          <img
            className="iconBlock"
            src={
              cartContext.currentFootClick !== 'order'
                ? './footer_icon/Asset 9.png'
                : './footer_icon/refundFooter.png'
            }
            alt="dollar-img"
          ></img>
          <span>Orders</span>
        ...
        <div className="linkFooter infoIcon" onClick={infoClicking}>
          <img
            className="iconBlock"
            src={
              cartContext.currentFootClick !== 'info'
                ? './footer_icon/Asset 10.png'
                : './footer_icon/infoFooter.png'
            }
            alt="infor-img"
          ></img>
          <span>Info</span>
        ...
        <div className="linkFooter userIcon" onClick={userClicking}>
          <img
            className="iconBlock"
            src={
              cartContext.currentFootClick !== 'profile'
                ? './footer_icon/Asset 8.png'
                : './footer_icon/profileFooter.png'
            }
            alt="user-img"
          ></img>
          <span>Profile</span>
