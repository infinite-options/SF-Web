    ...
    <div>
      ...
      <div className="backArrowCart">
        <Link className="link" to="/products">
          <i className="fas fa-chevron-left fa-lg"> Back</i>
        </Link>
      </div>

      <div className="threeBottonOrders">
        <button className="checkoutAndRefundBtn" onClick={goCheckout}>
          Checkout
        </button>
        <button className="HistoryButton" onClick={goHistory}>
          History
        </button>
        <button className="checkoutAndRefundBtn" onClick={goRefund}>
          Refund
        </button>
      </div>
    </div>
