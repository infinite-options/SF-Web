...
function Days() {
  ...
  if (topNode.busIsLoad && !topNode.busError) {
    ...
    return (
      <div>
        <header className="sticky headerheightDaysPage">
          <HeaderDays title={title} />
        </header>
        <div className="bodyDays">
          <p className="indentFilteringLine">
            Filter By <mark className="greenWord">Farmer's market</mark>
          </p>
          <div className="scrolling-wrapper">
            {farmerMarket.map(createMarketCard)}
          </div>

          <p className="indentFilteringLine">
            Filter By <mark className="greenWord">Farms</mark>
          </p>
