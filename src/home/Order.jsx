...
const [coordinates, setCoordinates] = React.useState({
  ...
  return (
    <div style={{backgroundColor:'white',height:'auto'}}>
      <div style={{marginRight:'auto',marginLeft:'auto'}}><h1 style={{color:'rgb(54,97,102)',float:'center',marginLeft:'auto',marginRight:'auto',marginBottom:'5px'}}>Ready to Order</h1></div>
      <div style={{marginRight:'auto',marginLeft:'auto'}}><h3 style={{color:'rgb(251,132,0)',float:'center',marginLeft:'auto',marginRight:'auto',marginBottom:'10px'}}>Fresh Organic Produce Delivered</h3></div>
    <div style={{width:'100%',marginLeft:'auto',marginRight:'auto',marginBottom:'25px'}}>
      <PlacesAutocomplete
        value={address}
        onChange={setAddress}
